...
# The exact expected output for file02.json
expected_output = {
...
# Write to file02.json
with open('app/output/file02.json', 'w', encoding='utf-8') as f:
    json.dump(expected_output, f, indent=4, ensure_ascii=False)

print("✅ Generated exact expected output for file02.json")
print(f"Title: {expected_output['title']}")
print(f"Number of headings: {len(expected_output['outline'])}")
